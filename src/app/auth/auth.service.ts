...
export class AuthService {
  ...
  createUser(email: string, password: string) {
    ...
    this.http.post<{ error: String }>("https://swarupfs.herokuapp.com/api/signup", authData)
  ...
  login(email: string, password: string) {
    ...
    this.http.post<{ error: String, token: string; expiresIn: number }>("https://swarupfs.herokuapp.com/api/login", authData)
      .subscribe(response => {
